...
נוצר ב: 2026-05-06T12:02:49.246Z
...
- סה״כ בדיקות (בערך): **1285**
- כשלים: **2**
- אזהרות: **0**

### כשלים חוזרים (דוגמה)

- `copilot_assert_weak_profile_answer_mentions_expected_weak_area`: 2

## איפה הקבצים

- תיקיית ריצה: `reports\parent-ai-mass-simulation\2026-05-06T12-01-48-714Z`
