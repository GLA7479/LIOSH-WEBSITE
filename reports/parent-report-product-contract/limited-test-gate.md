# Parent Report Limited Test Gate

- limited_test_gate: **READY_FOR_LIMITED_TEST**
- release_level: **NOT_READY_FOR_RELEASE**

## Checks
- [x] automated_release_gate_pass
- [x] seeded_browser_qa_pass
- [x] edge_browser_qa_pass
- [x] readability_10_10
- [x] short_consistency_10_10
- [x] zero_uncertain_skills_are_zero
- [x] question_critical_misses_zero

## Details
### automated_release_gate_pass
- status: PASS
- details: `"PASS"`
### seeded_browser_qa_pass
- status: PASS
- details: `"PASS"`
### edge_browser_qa_pass
- status: PASS
- details: `"PASS"`
### readability_10_10
- status: PASS
...
### question_critical_misses_zero
- status: PASS
- details: `{"exactDuplicateCrossGradeStaticBanksOnly":0,"mathKindsNotHitSample":0,"geoKindsNotHitSample":0}`