# external-question-gaps

**Human review only — not an automatic change to the product.**
...
```json
{
  ...
  "generatedAt": "2026-05-04T00:07:23.520Z",
  "totalTurns": 8,
  "uniqueSessionCount": 4,
  "phaseERouteCounts": {
    "phase_e:resolved_external_paste": 1,
    "phase_e:practice_suggestion_general": 1
  },
  "estimatedExternalOrGeneralEducationTurns": 1,
  "notes": "phase_e:* scopeReason values indicate Phase E routing (external / catalog / practice). Review-only."
}
```
