...
```json
{
  ...
  "clarificationRequiredTurns": 2,
  "clarificationRate": 0.25,
  "validatorFailTurns": 1,
  "notes": "Persisted traces do not include numeric intent/score confidence; clarification and validator failure approximate 'unresolved / risky' turns."
}
```
