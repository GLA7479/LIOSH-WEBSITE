# Scenario: weak_hebrew_comprehension
...
- **Scenario id:** `weak_hebrew_comprehension`
- **Scenario type:** weak_topic_or_subject
- **Subject(s):** hebrew
- **Intended signal:** Hebrew reading_comprehension mastery signal below threshold.
  ...
  "skillFindings": [
    {
      ...
      "reasoning": [
        "Observed topic accuracy is approximately 36% over 22 questions in-window.",
...
[
  ...
  },
  {
    ...
    "difficultyAdjustedAccuracy": 30.6,
