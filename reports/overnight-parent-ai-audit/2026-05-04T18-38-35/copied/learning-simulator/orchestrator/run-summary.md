...
- **Mode:** full
- **Overall:** **PASS**
- **Started:** 2026-05-04T18:46:00.622Z
- **Finished:** 2026-05-04T18:53:52.092Z
- **Total duration:** 471469 ms

## Steps

| # | Stage | Script | Duration (ms) | Result |
| --- | --- | --- | ---: | --- |
| 1 | Coverage matrix | `qa:learning-simulator:matrix` | 791 | PASS |
| 2 | Schema validation (profiles + scenarios) | `qa:learning-simulator:schema` | 770 | PASS |
| 3 | Aggregate simulator (quick scenarios) | `qa:learning-simulator:aggregate` | 900 | PASS |
| 4 | Parent report assertions (Phase 3) | `qa:learning-simulator:reports` | 1730 | PASS |
| 5 | Engine truth audit (aggregation ↔ diagnosis V2 ↔ report model) | `qa:learning-simulator:engine` | 2832 | PASS |
| 6 | Professional diagnostic framework QA (mock contracts) | `qa:learning-simulator:diagnostic-framework` | 845 | PASS |
| 7 | Professional framework real scenario validation | `qa:learning-simulator:framework-real-scenarios` | 1911 | PASS |
| 8 | Engine completion summary artifact | `qa:learning-simulator:engine-completion-summary` | 782 | PASS |
| 9 | Question bank metadata gate (static scan + taxonomy blocking policy) | `qa:question-metadata` | 1439 | PASS |
| 10 | Question skill metadata QA | `qa:learning-simulator:question-skill-metadata` | 1278 | PASS |
| 11 | Misconception engine QA | `qa:learning-simulator:misconceptions` | 797 | PASS |
| 12 | Mastery engine QA | `qa:learning-simulator:mastery` | 828 | PASS |
| 13 | Dependency engine QA | `qa:learning-simulator:dependencies` | 954 | PASS |
| 14 | Calibration engine QA | `qa:learning-simulator:calibration` | 1007 | PASS |
| 15 | Reliability engine QA | `qa:learning-simulator:reliability` | 792 | PASS |
| 16 | Probe engine QA | `qa:learning-simulator:probes` | 842 | PASS |
| 17 | Cross-subject engine QA | `qa:learning-simulator:cross-subject` | 897 | PASS |
| 18 | Professional engine output QA | `qa:learning-simulator:professional-engine-output` | 963 | PASS |
| 19 | Professional engine synthetic validation | `qa:learning-simulator:professional-engine` | 1284 | PASS |
| 20 | Adaptive planner artifacts (metadata-backed non-live safety gate) | `test:adaptive-planner:artifacts` | 1653 | PASS |
| 21 | Adaptive planner runtime bridge (practice snapshot → recommendation) | `test:adaptive-planner:runtime` | 1344 | PASS |
| 22 | Adaptive planner recommendation UI mapping (Phase 3 gates) | `test:adaptive-planner:recommendation-ui` | 721 | PASS |
| 23 | Adaptive planner recommended practice (Phase 4 adapter + button rules) | `test:adaptive-planner:recommended-practice` | 721 | PASS |
| 24 | Adaptive planner AI explainer guards (Phase 5) | `test:adaptive-planner:ai-explainer` | 637 | PASS |
| 25 | Behavior checks (Phase 5) | `qa:learning-simulator:behavior` | 731 | PASS |
| 26 | Question integrity (Phase 4) | `qa:learning-simulator:questions` | 1812 | PASS |
| 27 | Matrix smoke (sampled cells → aggregate) | `qa:learning-simulator:matrix-smoke` | 948 | PASS |
| 28 | Coverage catalog (819 cells) | `qa:learning-simulator:coverage` | 898 | PASS |
| 29 | Unsupported cells classification | `qa:learning-simulator:unsupported` | 893 | PASS |
| 30 | Content gap audit (informational) | `qa:learning-simulator:content-gaps` | 823 | PASS |
| 31 | Content gap backlog (documentation) | `qa:learning-simulator:content-backlog` | 788 | PASS |
| 32 | Scenario coverage (fixtures + smoke) | `qa:learning-simulator:scenario-coverage` | 909 | PASS |
| 33 | Critical matrix deep assertions | `qa:learning-simulator:critical-deep` | 2485 | PASS |
| 34 | Profile stress (synthetic profiles) | `qa:learning-simulator:profile-stress` | 3473 | PASS |
| 35 | Scenario coverage (+ critical deep + profile stress) | `qa:learning-simulator:scenario-coverage` | 1134 | PASS |
| 36 | Render release gate (browser/SSR smoke for learning + parent-report) | `qa:learning-simulator:render` | 337454 | PASS |
| 37 | PDF export gate (parent-report file download) | `qa:learning-simulator:pdf-export` | 32170 | PASS |
| 38 | Deep longitudinal simulator | `qa:learning-simulator:deep` | 5107 | PASS |
| 39 | Next.js production build | `build` | 49130 | PASS |
| 40 | Parent report phase1 selftest | `test:parent-report-phase1` | 2174 | PASS |
| 41 | Parent narrative safety (artifact JSON) | `test:parent-report-narrative-safety-artifacts` | 1511 | PASS |
| 42 | Intelligence layer v1 usage selftest | `test:intelligence-layer-v1-usage` | 1359 | PASS |
| 43 | Release readiness summary (master QA artifact) | `qa:learning-simulator:release-summary` | 808 | PASS |
