...
- **Scenario id:** `prerequisite_gap`
- **Scenario type:** dependency
- **Subject(s):** math
- **Intended signal:** Weak fractions with weak arithmetic prerequisite → prerequisite gap + probe target.
  ...
  "skillFindings": [
    {
      ...
      "reasoning": [
        "Observed topic accuracy is approximately 32% over 22 questions in-window.",
...
```json
{
  ...
  "topicRows": [
    {
      "subjectId": "math",
      "rowKeyShort": "fractions … (graded row)",
      "questions": 22,
      "correct": 7,
      "wrong": 15,
      "accuracy": 32,
    ...
    {
      "subjectId": "math",
      "rowKeyShort": "addition … (graded row)",
      "questions": 18,
      "correct": 6,
      "wrong": 12,
      "accuracy": 33,
