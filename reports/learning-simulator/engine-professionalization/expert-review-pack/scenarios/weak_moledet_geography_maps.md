# Scenario: weak_moledet_geography_maps
...
- **Scenario id:** `weak_moledet_geography_maps`
- **Scenario type:** weak_topic_or_subject
- **Subject(s):** moledet-geography
- **Intended signal:** Moledet maps skill weakness.
  ...
  "skillFindings": [
    {
      ...
      "reasoning": [
        "Observed topic accuracy is approximately 35% over 26 questions in-window.",
        "Subject-level question volume in-window is approximately 26.",
...
[
  ...
  {
    "subjectId": "moledet-geography",
    "gradeExpectation": 61.5,
    "difficultyAdjustedAccuracy": 29.8,
  ...
  "probes": [
    {
      ...
      "targetSubjectId": "moledet-geography",
      "targetSkillId": "directions",
