...
- **Scenario id:** `mixed_strengths`
- **Scenario type:** trend_mixed
- **Subject(s):** math, hebrew
- **Intended signal:** Math strong vs Hebrew weak separation.
  ...
  "skillFindings": [
    {
      ...
      "reasoning": [
        "Observed topic accuracy is approximately 95% over 40 questions in-window.",
...
[
  {
    "subjectId": "math",
    "gradeExpectation": 65,
    "difficultyAdjustedAccuracy": 80.8,
