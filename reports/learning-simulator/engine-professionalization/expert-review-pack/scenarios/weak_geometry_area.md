...
- **Scenario id:** `weak_geometry_area`
- **Scenario type:** weak_topic_or_subject
- **Subject(s):** geometry
- **Intended signal:** Geometry area weakness captured.
  ...
  "skillFindings": [
    {
      ...
      "reasoning": [
        "Observed topic accuracy is approximately 38% over 26 questions in-window.",
  ...
  "probes": [
    {
      ...
      "targetSubjectId": "geometry",
      "targetSkillId": "shapes",
