...
- **Mode:** quick
- **Overall:** **PASS**
- **Started:** 2026-05-03T14:30:24.239Z
- **Finished:** 2026-05-03T14:30:32.086Z
- **Total duration:** 7846 ms
...
| 2 | Schema validation (profiles + scenarios) | `qa:learning-simulator:schema` | 739 | PASS |
| 3 | Aggregate simulator (quick scenarios) | `qa:learning-simulator:aggregate` | 664 | PASS |
| 4 | Parent report assertions (Phase 3) | `qa:learning-simulator:reports` | 1439 | PASS |
| 5 | Engine truth audit (aggregation ↔ diagnosis V2 ↔ report model) | `qa:learning-simulator:engine` | 2615 | PASS |
| 6 | Behavior checks (Phase 5) | `qa:learning-simulator:behavior` | 651 | PASS |
| 7 | Question integrity (Phase 4) | `qa:learning-simulator:questions` | 1045 | PASS |
