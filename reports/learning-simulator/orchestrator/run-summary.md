...
- **Mode:** full
- **Overall:** **PASS**
- **Started:** 2026-05-03T13:25:49.905Z
- **Finished:** 2026-05-03T13:31:02.758Z
- **Total duration:** 312852 ms

## Steps

| # | Stage | Script | Duration (ms) | Result |
| --- | --- | --- | ---: | --- |
| 1 | Coverage matrix | `qa:learning-simulator:matrix` | 639 | PASS |
| 2 | Schema validation (profiles + scenarios) | `qa:learning-simulator:schema` | 628 | PASS |
| 3 | Aggregate simulator (quick scenarios) | `qa:learning-simulator:aggregate` | 661 | PASS |
| 4 | Parent report assertions (Phase 3) | `qa:learning-simulator:reports` | 1395 | PASS |
| 5 | Engine truth audit (aggregation ↔ diagnosis V2 ↔ report model) | `qa:learning-simulator:engine` | 2479 | PASS |
| 6 | Professional diagnostic framework QA (mock contracts) | `qa:learning-simulator:diagnostic-framework` | 637 | PASS |
| 7 | Professional framework real scenario validation | `qa:learning-simulator:framework-real-scenarios` | 1417 | PASS |
| 8 | Engine completion summary artifact | `qa:learning-simulator:engine-completion-summary` | 634 | PASS |
| 9 | Question skill metadata QA | `qa:learning-simulator:question-skill-metadata` | 902 | PASS |
| 10 | Misconception engine QA | `qa:learning-simulator:misconceptions` | 629 | PASS |
| 11 | Mastery engine QA | `qa:learning-simulator:mastery` | 639 | PASS |
| 12 | Dependency engine QA | `qa:learning-simulator:dependencies` | 617 | PASS |
| 13 | Calibration engine QA | `qa:learning-simulator:calibration` | 614 | PASS |
| 14 | Reliability engine QA | `qa:learning-simulator:reliability` | 600 | PASS |
| 15 | Probe engine QA | `qa:learning-simulator:probes` | 613 | PASS |
| 16 | Cross-subject engine QA | `qa:learning-simulator:cross-subject` | 606 | PASS |
| 17 | Professional engine output QA | `qa:learning-simulator:professional-engine-output` | 675 | PASS |
| 18 | Professional engine synthetic validation | `qa:learning-simulator:professional-engine` | 686 | PASS |
| 19 | Behavior checks (Phase 5) | `qa:learning-simulator:behavior` | 670 | PASS |
| 20 | Question integrity (Phase 4) | `qa:learning-simulator:questions` | 892 | PASS |
| 21 | Matrix smoke (sampled cells → aggregate) | `qa:learning-simulator:matrix-smoke` | 688 | PASS |
| 22 | Coverage catalog (819 cells) | `qa:learning-simulator:coverage` | 691 | PASS |
| 23 | Unsupported cells classification | `qa:learning-simulator:unsupported` | 627 | PASS |
| 24 | Content gap audit (informational) | `qa:learning-simulator:content-gaps` | 615 | PASS |
| 25 | Content gap backlog (documentation) | `qa:learning-simulator:content-backlog` | 583 | PASS |
| 26 | Scenario coverage (fixtures + smoke) | `qa:learning-simulator:scenario-coverage` | 610 | PASS |
| 27 | Critical matrix deep assertions | `qa:learning-simulator:critical-deep` | 1911 | PASS |
| 28 | Profile stress (synthetic profiles) | `qa:learning-simulator:profile-stress` | 2517 | PASS |
| 29 | Scenario coverage (+ critical deep + profile stress) | `qa:learning-simulator:scenario-coverage` | 623 | PASS |
| 30 | Render release gate (browser/SSR smoke for learning + parent-report) | `qa:learning-simulator:render` | 29507 | PASS |
| 31 | PDF export gate (parent-report file download) | `qa:learning-simulator:pdf-export` | 230219 | PASS |
| 32 | Deep longitudinal simulator | `qa:learning-simulator:deep` | 2387 | PASS |
| 33 | Next.js production build | `build` | 21273 | PASS |
| 34 | Parent report phase1 selftest | `test:parent-report-phase1` | 1043 | PASS |
| 35 | Parent narrative safety (artifact JSON) | `test:parent-report-narrative-safety-artifacts` | 1179 | PASS |
| 36 | Intelligence layer v1 usage selftest | `test:intelligence-layer-v1-usage` | 930 | PASS |
| 37 | Release readiness summary (master QA artifact) | `qa:learning-simulator:release-summary` | 803 | PASS |
