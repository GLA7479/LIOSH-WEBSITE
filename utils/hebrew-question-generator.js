...
const G1_EASY_QUESTIONS = {
  reading: [
    ...
    { question: "מה המילה הנכונה: כ___ב?", answers: ["כלב", "כלבה", "כבל", "כלוב"], correct: 0 },
    ...
    { question: "קרא את המילה: 'ספר'", answers: ["ספר", "ספור", "ספרי", "ספרה"], correct: 0 },
  ...
  writing: [
    { question: "איך כותבים את המילה 'בית'?", answers: ["בית", "באת", "ביתה", "בתי"], correct: 0 },
    { question: "איך כותבים את המילה 'אמא'?", answers: ["אמא", "אמה", "אימא", "אמאה"], correct: 0 },
    { question: "בחרו משפט עם ניסוח תקין (כיתה א׳ — קל):", answers: ["אני בבית", "אני בבית בבית", "אני גר בבית ספר", "אני בבית."], correct: 0 },
    { question: "איך כותבים את המילה 'כלב'?", answers: ["כלב", "כלבה", "כבל", "כלוב"], correct: 0 },
    ...
    { question: "איך כותבים את המילה 'ספר'?", answers: ["ספר", "ספור", "ספרי", "ספרה"], correct: 0 },
  ...
  grammar: [
    ...
    { question: "בחרו משפט תקין — התאמת גוף לכלב (כיתה א׳):", answers: ["הכלב רץ", "הכלב רצים", "הכלב רצה", "כלבים רץ"], correct: 0 },
    ...
    { question: "מה המשפט התקין לגבי דג ופועל ׳שוחה׳?", answers: ["הדג שוחה", "הדג שוחים", "דגים שוחה", "הדג שוחות"], correct: 0 },
...
const G1_HARD_QUESTIONS = {
  reading: [
    ...
    { question: "קרא את המשפט: 'הכלב רץ בחצר'", answers: ["הכלב רץ בחצר", "הכלב רצים בחצר", "כלבים רץ בחצר", "כל התשובות נכונות"], correct: 0 },
...
const G2_EASY_QUESTIONS = {
  ...
  writing: [
    ...
    { question: "איזה משפט נכון?", answers: ["אני קורא ספר", "אני קוראת ספר", "אני קוראים ספר", "אני קוראות ספר"], correct: 0 },
    { question: "איך כותבים את המילה 'מחברת'?", answers: ["מחברת", "מחברתה", "מחברתי", "מחברתא"], correct: 0 },
    {
...
const G2_HARD_QUESTIONS = {
  ...
  comprehension: [
    ...
    { question: "כשהשמש זורחת בבוקר ומאירה את העולם — מה המשמעות?", answers: ["יש אור וחום מהשמש", "השמש נעלמת", "הכל חשוך", "רק עננים"], correct: 0 },
    {
