...
const G1_EASY_QUESTIONS = {
  ...
  writing: [
    ...
    { question: "בחרו משפט עם ניסוח תקין (כיתה א׳ — קל):", answers: ["אני בבית", "אני בביתבית", "אני בביתכלב", "אני בבית בית"], correct: 0 },
    ...
    { question: "בחרו משפט תקין — התאמת גוף לפועל ׳יושב׳:", answers: ["אני יושב", "אני יושבת", "אני יושבים", "אני יושבות"], correct: 0 },
    ...
    { question: "זיהוי התאמת גוף — איזה משפט על ׳משחק׳ נכון?", answers: ["אני משחק", "אני משחקת", "אני משחקים", "אני משחקות"], correct: 0 },
  ...
  grammar: [
    ...
    { question: "בחרו משפט תקין — התאמת גוף לכלב (כיתה א׳):", answers: ["הכלב רץ", "הכלב רץו", "הכלב רץה", "כלבים רץ"], correct: 0 },
    { question: "מה חלק הדיבר של המילה 'יפה'?", answers: ["תואר", "שם עצם", "פועל", "מספר"], correct: 0 },
    { question: "איזה ניסוח מתאים לגוף ולמין (ילד/ילדה)?", answers: ["הילד רץ", "הילד רץו", "הילדה רץ", "הילדים רץ"], correct: 0 },
    ...
    { question: "בחרו משפט תקין — חתול ופועל ׳ישן׳:", answers: ["החתול ישן", "החתול ישנה", "חתולים ישן", "החתול ישנים"], correct: 0 },
    { question: "מה חלק הדיבר של המילה 'גדול'?", answers: ["תואר", "שם עצם", "פועל", "מספר"], correct: 0 },
    { question: "מה המשפט התקין לגבי דג ופועל ׳שוחה׳?", answers: ["הדג שוחה", "הדג שוחהו", "דגים שוחה", "הדג שוחים"], correct: 0 },
