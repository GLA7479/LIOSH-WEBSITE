...
const G1_HARD_QUESTIONS = {
  ...
  comprehension: [
    ...
    { question: "כשכותבים 'ילדים משחקים בחצר' — מה הם עושים?", answers: ["משחקים", "קוראים שיעור", "ישנים", "אוכלים ארוחת צהריים בכיתה"], correct: 0 },
...
const G2_EASY_QUESTIONS = {
  ...
  comprehension: [
    ...
    { question: "כשכותבים 'ילדים משחקים בחצר' — מה הם עושים?", answers: ["משחקים", "קוראים שיעור", "כותבים מבחן", "אוכלים ארוחת ערב"], correct: 0 },
