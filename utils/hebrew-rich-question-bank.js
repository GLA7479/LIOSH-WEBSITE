...
export const HEBREW_RICH_POOL = [
  ...
  },
  {
    ...
    binary: true,
    question:
      "שאלת נכון/לא נכון לכיתה א׳: האם נכון שבלילה רואים לרוב את הירח ולא את השמש?",
  ...
  },
  {
    ...
    subtype: "tf_language_aware",
    distractorFamily: "polar",
    optionCount: 2,
    binary: true,
    question:
      "בדקו טענה: המשפט 'הילדים משחקים בחצר' מתאר פעולה שקורית עכשיו (הווה). נכון או לא נכון?",
    answers: ["נכון", "לא נכון"],
    correct: 0,
  },
  {
  ...
  // ——— דקדוק: הסכמה, זמן, תיקון ———
  {
    ...
    question: "התאמת דובר לכיתה א׳: 'הילדה הקטנה ___ על הספסל ומחייכת.'",
  ...
  },
  {
    ...
    distractorFamily: "agreement_error",
    question: "בחרו צורה נכונה לכיתה ב׳: 'הילדים הגבוהים ___ סביב השולחן.'",
    answers: ["יושבים", "יושב", "יושבת", "יושבות"],
    correct: 0,
  },
  {
    topic: "grammar",
  ...
  },
  {
    ...
    question: "מילה במשפט (כיתה א׳): אני שותה ___ כשאני צמא אחרי האוכל.",
  ...
  },
  {
    ...
    distractorFamily: "orthography",
    question: "איזו כתיב מלאה ומדויקת למילה 'מחברת'?",
  ...
  // ——— דיבור ———
  {
    ...
    question:
      "מצב: מישהו אומר 'סליחה' אחרי שנתקל בך בטעות. תשובה מנומסת לכיתה א׳:",
  ...
  },
  {
    ...
    distractorFamily: "wrong_register",
    question:
      "מישהו אומר לך 'תודה רבה' אחרי שעזרת לו לאסוף עיפרון. מה עונים בנימוס?",
