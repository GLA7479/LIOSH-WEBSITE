...
export const HEBREW_RICH_POOL = [
  ...
  },
  {
    ...
    optionCount: 4,
    binary: false,
    question: "לגבי המשפט ׳הילדים משחקים בחצר׳ — מה נכון?",
    answers: [
      "המשפט מתאר פעולה שקורית עכשיו (הווה)",
      "המשפט מתאר משהו שקרה אתמול בלבד",
      "המשפט מתאר תכנית לעתיד בלבד",
      "אין במשפט פועל בכלל",
    ],
    correct: 0,
  },
  ...
  // ——— קריאה ———
  {
    ...
    question: "איך כותבים נכון את המילה 'בית'?",
  ...
  // ——— דיבור ———
  {
    ...
    question:
      "מישהו אומר 'סליחה' אחרי שנתקל בך בטעות. מה עונים בנימוס?",
