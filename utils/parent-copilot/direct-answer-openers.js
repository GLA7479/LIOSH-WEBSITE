...
export function parentDirectOpenerHe(intent, truthPacket) {
  ...
  switch (k) {
    ...
    case "what_is_most_important":
      return fragile
        ? "עדיפות ראשונה היא לא «להחליט הכול היום», אלא לטפל במה שהדוח עדיין מציג כפתוח או זהיר."
        : "אפשר לסדר עדיפות לפי מה שהדוח כבר מנסח בבירור — בלי להרחיב מעבר לזה.";
    ...
    case "why_not_advance":
      return "עצירת קידום או האטה מופיעות בדוח כשהניסוח עדיין לא סוגר מספיק — לא בהכרח כישלון.";
    case "what_is_going_well":
      return "מה שמסומן בדוח כחזק הוא מה שנמדד שם כרגע כיציב יחסית — לא הערכת אופי.";
    ...
    case "strength_vs_weakness_summary":
      return "הדוח נותן שני כיוונים — מה נראה יחסית חזק ומה עדיין דורש עבודה — בתוך אותו טווח נתונים.";
    default:
      return exec
