...
function buildInterpretationSlot(envelope, cannotConcludeYet, seed) {
  ...
  if (envelope === "WE3") {
    return pickVariant(seed, [
      "הכיוון נראה יציב יחסית בתקופה הזו, עם מעקב רגיל כרגיל.",
  ...
  return pickVariant(seed, [
    "יש כאן יציבות טובה יחסית, ובלי לאבד עניין בעיניים — נמשיך מדי פעם לבדוק שהכול נשאר רגוע גם תחת לחץ.",
...
function buildUncertaintySlot(hedgeLevel, seed) {
  ...
  if (hedgeLevel === "light") {
    return pickVariant(seed, [
      ...
      "נעשה עוד תרגול קצר ואז נחזור לזה — בעיניים פתוחות וללא למהר.",
    ]);
  }
  return null;
}
