...
export const SCIENCE_QUESTIONS_PHASE3 = [
  ...
  },
  {
    ...
    "theoryLines": [
      "ביו־מגנום והצטברות רעלנים בשרשרת המזון.",
  ...
  },
  {
    ...
    "options": [
      "כי השתנו שני גורמים בו־זמנית (אור והדשן) ולכן לא ברור מה גרם להבדל",
  ...
  },
  {
    ...
    "maxLevel": "hard",
    "type": "mcq",
    "stem": "בניסוי חימום מים, חוקר הוסיף בו־זמנית יותר מלח וגם הגביר את להבה. מה הבעיה בניסוח מסקנה 'המלח האיך את החימום'?",
    "options": [
  ...
  },
  {
    ...
    "maxLevel": "hard",
    "type": "mcq",
    "stem": "תלמיד מדד אורך פריסה חמש פעמים קיבל 10.0, 10.1, 9.9, 10.0, 10.2 ס״מ אך המד סרט היה קצר ב־סנטימטר מכל התוויות. מה נכון לגבי השגיאה כאן?",
    "options": [
  ...
  },
  {
    ...
    "options": [
      "בסטרטוספרה; צמצום קרינת מעל־סגול קשיחה מפחית נזקים ל-DNA בעור, בצמחים ולמערכות אקולוגיות רגישות",
  ...
  },
  {
    ...
    "options": [
      "כי המים ממיסים סידן ומצטברים מחדש בהדרגה; המסה והשקיעה הם תהליכי טיפה־טיפה",
