...
export const SCIENCE_QUESTIONS_PHASE3 = [
  // --- environment (26) ---
  {
    ...
    correctIndex: 0,
    explanation:
      "בטון ואספלט חמים נוטים לחמם את הסביבה ולפחית אידוי מים מצמחים; ביום חם זה מגביר לעיתים אפקט חום ומרגיש 'לחץ חום' בעיר. לחות יחסית לעיתים יורדת כי פחות אידוי מצמחים ופחות קירור מקומי מצל וממים.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "השקיית יתר עלולה לדכא חמצן בנרהיזוספירה, לפגוע בקליטת מזון ושורשים ולהפחית יעילות — לעיתים מופיעים גם בצקות או ריקבון שורש. לא 'דילול כלורופיל' ולא עצירת CO₂ לנצח הם ההסבר המרכזי.",
    theoryLines: [
  ...
  },
  {
    ...
    options: [
      ...
      "רק צמחים איטיים הם מסוכנים לסביבה ולכן מהירות היא תמיד סימן חיובי",
      "גדילה מהירה מוכיחה שאין צורך בניטור קרקע או מים",
      "מגוון מינים גדול תמיד עולה בלי קשר לשטח או למשאבים",
    ],
    correctIndex: 0,
    explanation:
      "יתרון תחרותי חד־פעמי עלול ללחוץ על מינים אחרים, לפגוע במאגרים גנטיים ובשירותים אקולוגיים. לכן נדרשת חשיבה מערכתית, לא רק תשואה לשדה בודד.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "רשתות אקולוגיות מורכבות; איבוד טורף עליון עשוי לשנות אוכלוסיות של טורפים/נטרפים אחרים בדרכים שונות. אין כלל אחד פשוט לכל האגמים.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "היררכיית 3R שמה 'הפחתה' לפני 'מיחזור'. הפחתת שימוש יורדת היקף גזירה/ייצור; מיחזור עוסק במוצרים לאחר שימוש כדי לצמצם הטמנה ולחסוך חומר גלם.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "מנגנון החממה: קרינה קצרת־גל קולטת, פליטה ארוכת־גל חזקה יותר, ונבנית שיווי משקל חם יותר. זה לא 'פחות שמש' בהכרח אלא שינוי בחוזק הלכידה.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "אי־דיוק ביישום, נשיאה במים, או רגישות שונה בין מינים יוצרים דליפה אקולוגית. לכן חשוב ייעוץ, מינון, ומניעת חשיפה מיותרת.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "בלי ויסות, טורף חדש יכול לדכא נטרפים עד לנקודת מנוסה או להכחיד מינים; זה מסכן יציבות. המקרה מדגים חדירת מינים פולשים.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "מתחדשות מפחיתה פליטות דלקים פוסיליים אך עם שטחי תשתית, לוגיסטיקה ופירוק. צריך ניתוח מחזור חיים ולא סיסמה.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "בשרשרת מזון דרושה בסיס פרימרי (צמחים/ פלנקטון). עומס דגים עלול לערער יציבות, להגדיל דלקון או לדכא נטרפים אחרים — לא להגדיל אוטומטית 'מלאי מזון'.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "גשם חזק על שטח חשוף או מהודק עלול להדיח דשן וחומרים אל תוך מי נגר, נחלים ומאגרים. זה מדגיש חיבור בין מזג אקסטרימלי, קרקע וזיהום.",
    theoryLines: [
  ...
  },
  {
    ...
    options: [
      ...
      "רק מזג האוויר הוא תמיד זהה בכל העיר בכל רגע",
      "ים משחרר רק מלח ולכן לא משפיע על לחות",
      "קיץ משמעו בוודאות אפס אידוי בעולם",
    ],
    correctIndex: 0,
    explanation:
      "בקיץ לעיתים 'עונה יבשה' אזורית, אך ליד הים עשויים להיות אדים, ובריבוי בטון וחום עירוני עלולה להיות תחושת חום מעיקה. נדרש הבחנה בין מעט משקעים לבין תנאי נוחות תרמית.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "צמחי גדות משפרים מבנה קרקע, מפחיתים סחיפה ותומכים במיקרואורגניזמים המפרקים. זה לא תחליף מלא לטיפול אבל חשוב במערכת.",
    theoryLines: [
  ...
  },
  {
    ...
    options: [
      ...
      "רק דייגים חוקיים משפיעים על אוכלוסייה",
      "בריחה מחמירה אוטומטית מעלה את גודל הזכר מיד",
    ],
    correctIndex: 0,
    explanation:
      "השפעה אקולוגית נובעת מכלל ההסרה בפועל. אכיפה חלשה יכולה לבטל הפחתה 'על הנייר'.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "מעיינות רבים תלויים בתמיכה של מי תהום ושבילי זרימה. חישוב הידרולוגי חסר עלול להפחית האכלות או לשנות לחץ־מים אזורי.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "בלי גזי חממה טבעיים הטמפרטורה הייתה קרירה מדי לחיים רבים; הבעיה היא חיזוק יתר. גורמים לבלבול במונחים ולדיון לא מדויק.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "מסדרונות ורציפות שטח תומכים בהגירה, בגנים ובגיוון. פיצול בתי גידול מגביר סיכון לקריסה דמוגרפית.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "מדענים מתקנים הטיות (באיאסים) ומשווים רשתות שונות. זהירות מתודולוגית היא לא 'ספוט' אלא דיוק.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "התאמה לאקלים מפחיתה לחץ על משאבים ומחזקת קשרים עם מזהמי אבקה וטורפים טבעיים; מינים זרים עלולים להפוך לפולשים.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "מתכות כבדות נוטות להצטבר במשקעים ובביומסה; פגיעה בתחתית שרשרת המזון מסמנת סכנה רחבה. צריך ניטור ומקור זיהום.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "ביומסה וקרקע אוגרים פחמן; שינוי מהיר משחרר לאטמוספרה או מקטין קליטה עתידית. זה חלק מחשבון מקורות־שקע.",
    theoryLines: [
      "יערות הם מאגרי פחמן.",
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "ניהול מבקרים, נתיבים, עונות רגישות וחינוך מפחיתים דחיפה אקולוגית. תיירות ברת־קיימא היא איזון.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "אפקט מסדרון/פיצול (habitat fragmentation) מגביר דריפט גנטי, מקריס סיכויי הישרדות מפני אירועים אקראיים ומקטין שטח מזון הולם.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      "פתיחת ניקוזים עלולה להזרים במי גשם שטחים מזוהמים, לא רק 'לשטוף' זיהום החוצה; יש צורך בניטור לזמן ולמקום ולסיכון אקולוגי.",
    theoryLines: [
  ...
  },
  {
    ...
    options: [
      ...
      "רק כשקומפוסט נרכש מחו״ל בלבד",
      "רק כשאין שום צמח בגינה",
    ],
    correctIndex: 0,
    explanation:
      "פירוק אורגני מקומי מקטין נפח להטמנה (פחות מתאן מהירקות) ומחזיר חומר למחזור הקרקע אם הבטיחות הביולוגית נשמרת.",
    theoryLines: [
  ...
  },
  {
    ...
    options: [
      ...
      "רק טמפרטורה חשובה לאיכות אוויר",
    ],
    correctIndex: 0,
    explanation:
      "ניטור אוויר רגיש לפרוטוקול: גובה דגימה, זמן, כיול ושקיפות. השוואה ללא סטנדרט פוגעת באמון ובמדיניות.",
    theoryLines: [
  ...
  // --- experiments (26) ---
  {
    ...
    correctIndex: 0,
    explanation:
      "במבחן הוגן משנים רק משתנה אחד ממוקד. כאן האור הוא 'מפריע' (confounder) שמונע מסקנה נקייה.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "שחזור (replication) מחזק אמון: אם דפוס חוזר, הסיכוי שהוא 'קולע במקרה' קטן. זה חלק מתרבות האימות במדע.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "בקרה מאפשרת להבדיל בין 'מה היה קורה בלי הטיפול' לבין 'מה שקרה אחרי הטיפול'. בלי זה קשה לפרש הבדלים.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "דגימה במקום/זמן מאפיין מערך מצומצם של אנשים. מסקנות 'לכולם' דורשות אסטרטגיית דגימה רחבה או הצהרה מפורשת על ההגבלה.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "שגיאת כיול/מכשיר שיטתית נוטה לכיוון קבוע. לעומת 'רעש' אקראי, כאן חוזרת אותה הטיה בכל מדידה — חשוב לזהות ולמתקן.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "כשני גורמים משתנים, ההבדל בתוצאה הוא 'תערובת השפעות'. צריך ניסויים נפרדים או טבלת גורמים מתוכננת.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "אפקט פלצבו/המלצה מדגים שדיווח אנושי אינו רק 'מדידה נקייה'. בקרה מאפשרת להעריך עודף אמיתי מעבר לציפייה.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "שחזור הוא אבן יסוד: בלי פרוטוקול, ממצאים נשארים סיפור אישי. תיעוד תומך בלמידה קולקטיבית.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "עקביות (פיזור קטן) לא מבטיחה דיוק: מכשיר מוסט יכול לתת ערכים חוזרים אך שגויים באותו כיוון. צריך כיול והשוואה למוערך אמת.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "רעש סטטיסטי גדול כשהמונה קטן: חוסר נביטה יחיד עלול להטעות. חזרות ודגימה גדולה יותר מייצבות הערכת שיעור.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "ניסויים עם בני אדם דורשים חשיבה אתית וגם של מודעות לשינוי התנהגותי. לפעמים צריך תכנון חלופי או דיווח מפורש על המגבלה.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "השערה מנחה את הבדיקה; המסקנה משקפת מה הנתונים תומכים בהן. אפשר לדחות השערה — זה תקין ומעיד על כנות מחקרית.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "הוגנות פירושה בידוד גורם אחד: אחרת ההבדל יכול לנבוע ממזל או מתנאי נסתר, לא מהשיטה.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "מגבלות משאבים, רעילות בכמות גבוהה ושימוש יעיל משתנים לפי רמה — לכן עקומות צמיחה אינן קו ישר פשוט.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "בטיחות במעבדה כוללת זיהוי חומרים, הוראות מורה וציוד. סקרנות טובה מתכננת מראש, לא מסתכנת 'על העיוור'.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "מתאמה (קורלציה) אינה סיבה: נתון 'זז יחד' לא מוכיח מנגנון; צריך הסבר, ניסוי או שליטה בגורמים.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "כשהמודד 'עיוור' לתנאי (בלינד), פחות סיכוי שהפרשנות תהיה מושפעת מדעה מוקדמת. זה כלי מתודולוגי בסיסי במחקרי חושים.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "טיפול בחריגים דורש בקרה: זה יכול להיות כיווץ אמת או טעות. מדענים מתעדים החלטות כדי לשמור על שקיפות.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "ריבוי ספרות אחרי הנקודה לא אומר שהמספר נכון לעולם. כיול מתקן ספי מידה; רזולוציה רק מתארת רגישות לשינוי קטן.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "תיעוד גולמי מאפשר לבדוק אם הפרשנות עקבית עם העובדות. זה גם לומדים מאחרים — ומשפרים יכולת ביקורת עצמית.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "שגיאת פרוצדורה/מכשיר קבועה יוצרת דפוס שיטתי. חזרה מחזקת את הסיכון הזה אם לא מתקנים מקור.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "שקיפות מתודולוגית היא חלק מאחריות: בלי פרוטוקול ברור, קשה להפריד בין תגלית לבין טעות או מזל.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "משתנה עצמאי הוא מה שבוחרים לשנות; תלוי הוא מה שמודדים כתגובה. דיוק בשפה עוזר לתכנן טבלאות וגרפים.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "ממצא מצטבר יכול להתהפך כשמבחינים בקבוצות משנה — לכן חשוב לשאול 'על איזה חתך מדברים'.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "טמפרטורה היא משתנה מפתח לקצב וללחץ אדי; אם היא שונה בין קבוצות, קשה לייחס שינוי לחומץ.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "ביקורת עמיתים היא סינון ושיפור, לא אורקל: ממצאים יכולים להשתנות אחרי שחזורים. עם זה היא מפחיתה טעויות גסות.",
    theoryLines: [
  ...
  // --- earth_space (20) ---
  {
    ...
    correctIndex: 0,
    explanation:
      "גיאומטריית קרינה ויום־שנה קובעים כמה אנרגיה מגיעה ליחידת שטח לאורך זמן — זה בסיס להבנת חגורות אקלים.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "הבדלי חימום סגולי בין מים ליבשה יוצרים הבדלי לחץ מקומיים ורוחות ים־יבשה משתנות במחזור יומי.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "פאזות הירח נובעות מהאור הנראה המוחזר והצל שמטיל כדור הארץ/זווית השפעה — ענן יכול להסתיר אבל לא 'ליצור' פאזה.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "אטמוספירה פעילה אינה חממה זכוכית פשוטה, אבל הרעיון המרכזי: כשחלק מהאנרגיה הנפלטת חוזר פנימה, המאזן הקרינתי מתחמם בממוצע.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "משקעים נוצרים מהצטברות והלחמה; הם מייצגים שלבים סביבתיים בהם נותרו עקבות חיים. סלעים מותכים 'מחקו' לעיתים מבנים עדינים.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "סיבוב כדור הארץ מוסיף הסטה לתנועה גדולה בזמן; זה לא מסביר קומפס יומי בכוס מים, אבל כן דפוסים גלובליים במודלים פשוטים.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "ניהול נוף משפיע על מהירות המים והעומס אצל המשקעים. הגנה במקור מפחיתה עלויות בקהילות במורד הזרימה.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "ענן אפר געשי חזק יכול להישא לאלפי קילומטרים; השפעה על ראות/מנועים ועל איזון קרינתי לטווח קצר — נושא שקשור גם לאקלים וגם לבטיחות טיסה.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "אוזון הוא חלק מרכיבי אטמוספירה מורכבת; פגיעה בו מחברת חשיפת קרינה לבריאות ולמערכות ייצור מזון.",
    theoryLines: [
  ...
  },
  {
    ...
    options: [
      ...
      "רק התפשטות חום מהמדבר",
      "צבע המים בלבד",
    ],
    correctIndex: 0,
    explanation:
      "גאות קשורות לשדות משיכה ומומנט דוחה של שמש/ירח; רוח משפיעה אבל לא מסבירה לבד את המחזור הכפול היומי במקומות רבים.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "דינמיקת לוחות מסבירה מיקומי רעידות/חזיתות וטווח סיכון; זה בסיס להבנת סיכונים ולבנייה מותאמת.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "אלבדו (החזר) משפיע על כמה אנרגיה נבלעת; שינוי מקרח למים משנה מאזן אנרגיה מקומי ויכול לתמוך במשובים.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "קארסט הוא דינמיקה כימית־הידרולוגית; קצב איטי אבל מתמשך יוצר מבנים חדים.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "מפת גבולות לוחות מסייעת לחזות איפה אנרגיה גאולוגית משוחררת; זה כלי חשיבה גאוגרפי־מדעי.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "אנרגיה לטנטית מחומם האוקיינוס היא 'דלק' למערכות; לכן שינויי טמפרטורת ים קשורים לסיכון אזורי.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "המחזור הוא מודל מחשבתי המקשר תהליכים; בפועל היסטוריה גאולוגית יכולה להיות מורכבת ולכלול 'קפיצות' לסוג אחר.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "מערכת אקלים היא רבת־משתנים: אוקיינוס, ירח, אלבדו, זרימות. קו רוחב הוא נקודת התחלה, לא הסוף.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "משאבי מים תת־קרקעיים משותפים לעיתים; ניצול חריף פוגע בזמינות לחיים, חקלאות ונחלים.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "סיבוב יומי משנה קו אופק השמש ולכן צל; זה קשור לשעות, עונות וקו רוחב.",
    theoryLines: [
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "ניסוח מדעי מדויק מונע 'הסקות קופצניות' ממקרה בודד. זה חשוב בדיון על הקצה אקלימי.",
    theoryLines: [
