...
export const SCIENCE_QUESTIONS = [
  ...
  // ========= שאלות נוספות - גוף האדם (כיתות א'-ב', רמה קל) =========
  {
    ...
    options: ["עיניים", "אוזניים", "אף", "לשון"],
    correctIndex: 1,
  ...
  // ========= שאלות נוספות - גוף האדם (כיתות ג'-ד', רמה קל) =========
  {
    ...
    options: ["הקיבה", "הפה", "המעי הדק", "ושט"],
    correctIndex: 1,
  ...
  // ========= שאלות נוספות - צמחים (כיתות א'-ב', רמה קל) =========
  {
    ...
    options: ["שורשים", "עלים", "פרחים", "פירות"],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ["אבן", "מתכת", "כותנה", "זכוכית דקה"],
    correctIndex: 2,
  ...
  },
  {
    ...
    stem: "מה תפקיד מערכת העיכול?",
    options: [
      "קליטת מזון בפה בלי המשך במעיים",
      "קליטה, פירוק לחומרים קטנים, ספיגה והסרת פסולת",
      "שתייה בלבד בלי עיכול מוצקים",
      "תנועה של דופן הבטן בלי פירוק מזון",
    ],
    correctIndex: 1,
  ...
  },
  {
    ...
    stem: "מה צריך לעשות אחרי ניסוי?",
    options: [
      "להשאיר מדים מלוכלכים לניסוי הבא",
      "לנקות שולחן, לשטוף ידיים ולסדר ציוד",
      "לשמור כלי מלוכלכים בשקית לניסוי הבא בלי שטיפה",
      "לזרוק הכל יחד לאותה שקית בלי הבדלה",
    ],
    correctIndex: 1,
  ...
  },
  {
    ...
    stem: "מה תפקיד מערכת החיסון?",
    options: [
      "לייצר ריר חיץ שעוצר כל חדירת גורם מזהם בלא זיהוי",
      "לזהות ולהשמיד חיידקים, וירוסים וחומרים זרים שפולשים לגוף",
      "להעביר חמצן מריאות לשריר בקצב קבוע בלבד",
      "להפריש מיצי מרה לפירוק שומן במעיים",
    ],
    correctIndex: 1,
  ...
  },
  {
    ...
    stem: "מה קורה לקרח כשהוא מתחמם?",
    options: [
      "נשאר קרח אם לא חמים מספיק",
      "הופך למים",
      "הופך מיד לאדים בלי נוזל",
      "נהיה קשה יותר אך נשאר מוצק",
    ],
    correctIndex: 1,
  ...
  },
  {
    ...
    stem: "מה ההבדל בין חומר קשה לחומר רך?",
    options: [
      "חומר קשה תמיד נכפף בקלות, חומר רך תמיד שביר כמו זכוכית",
      "חומר קשה חזק ועמיד יותר, חומר רך עדין יותר ונוח יותר לעיוות",
      "השורה התחתונה: אין משמעות לכוח שמפעילים על החומר",
      "שניהם נבדלים רק בצבע ללא קשר לעמידות או גמישות",
    ],
    correctIndex: 1,
  ...
  },
  {
    ...
    stem: "מה צריך לעשות עם פסולת?",
    options: [
      "להשאיר אריזות בשביל 'שימוש חוזר' על המדרכה",
      "לזרוק בפח אשפה כדי לשמור על הסביבה נקייה",
      "לדחוס פסולת לתוך שיח בלי פח בסביבה",
      "להניח שרוח תנקה את האזור כך שלא נשאר פסולת",
    ],
    correctIndex: 1,
    explanation: "צריך לזרוק פסולת בפח אשפה. זה עוזר לשמור על הסביבה נקייה, יפה ובריאה.",
    theoryLines: [
  ...
  // ========= שאלות נוספות רבות - ניסויים (כיתות א'-ב') =========
  {
    ...
    stem: "מה צריך לעשות לפני שמתחילים ניסוי?",
    options: [
      "להתחיל בלי לקרוא הוראות כדי לראות מה קורה בלי תכנון",
      "לחשוב מה רוצים לבדוק ולהיות זהירים",
      "להסתמך על מה שקורה בטלוויזיה מבלי לבדוק שיטתית",
      "לערב רק חומרים שנראים דומים בלי רשימת כמויות",
    ],
    correctIndex: 1,
    explanation: "לפני ניסוי צריך לחשוב מה רוצים לבדוק ולהיות זהירים. מבוגר צריך לעזור.",
    theoryLines: [
  ...
  },
  {
    ...
    stem: "מה צריך לעשות אחרי ניסוי?",
    options: [
      "להשאיר כלים על השולחן עם שקיות ניסוי פתוחות",
      "לנקות ולסדר הכל",
      "לסמן במחברת 'בוצע' בלי לרשום מה נצפתה בפועל",
      "לפרק מיד את ההתקנה בלי לבדוק אם נשארו חומרים על הרצפה",
    ],
    correctIndex: 1,
    explanation: "אחרי ניסוי צריך לנקות ולסדר את הכל, כדי שהכל יהיה מוכן לשימוש הבא.",
    theoryLines: [
  ...
  },
  {
    ...
    stem: "למה חשוב לעשות ניסויים?",
    options: [
      "כי תיאוריה בספר תמיד תואמת את המציאות בלי בדיקה",
      "ללמוד על העולם, לבדוק רעיונות ולהבין איך דברים עובדים",
      "רק כדי לשחזר הדגמה מוכנה בלי שלב הניסוח של השאלה",
      "כדי לצלם סרטון קצר בלי רישום נתונים או השוואה",
    ],
    correctIndex: 1,
    explanation: "ניסויים עוזרים לנו ללמוד על העולם, לבדוק דברים, להבין איך דברים עובדים ולגלות דברים חדשים.",
    theoryLines: [
  ...
  },
  {
    ...
    stem: "מה צריך כשרואים משהו מעניין בניסוי?",
    options: [
      "להמשיך לערבב חומרים בלי לעצור לתיאור מילולי",
      "לצפות בזהירות, לרשום מה רואים ולחשוב מה זה אומר",
      "לסמוך שהמורה זוכרת במקום לרשום בעצמנו",
      "לעבור לניסוי אחר מיד כדי לא 'להיתקע' בשלב זה",
    ],
    correctIndex: 1,
    explanation: "כשרואים משהו מעניין, צריך לצפות בזהירות, לרשום מה רואים, לצייר אם צריך ולחשוב מה זה אומר.",
    theoryLines: [
  ...
  },
  {
    ...
    stem: "מה צריך לעשות לפני שמתחילים ניסוי?",
    options: [
      "לשנות משתנים אקראיים בלי לדעת מה בודקים",
      "לתכנן מה רוצים לעשות, להכין את החומרים ולהיות זהירים",
      "להתחיל בלי לבדוק אם יש צורך במבוגר מלווה",
      "לערבב חומרים בלי רשימת בדיקה של כמות וסדר",
    ],
    correctIndex: 1,
  ...
  },
  {
    ...
    stem: "מה צריך לעשות אחרי ניסוי?",
    options: [
      "להשאיר כלים עם שאריות חומר בלי לשטוף לפי ההנחיה",
      "לנקות, לכתוב מה למדנו ולחשוב מה זה אומר",
      "לסגור את המחברת בלי לעדכן מה התרחש בפועל",
      "לפרק את ההרכבה בלי לבדוק איפה נאספים נוזלים",
    ],
    correctIndex: 1,
  ...
  },
  {
    ...
    stem: "למה חשוב לעשות ניסויים?",
    options: [
      "כי חזרה על ניסוי אינה מוסיפה ידע כשמדווחים פעם אחת",
      "ללמוד, לבדוק ולהבין שיטתית איך דברים עובדים",
      "רק לשם שעשוע מהיר בלי מטרת בדיקה ברורה",
      "כדי לצפות ולסמוך על רושם אישי בלי תיעוד",
    ],
    correctIndex: 1,
  ...
  },
  {
    ...
    stem: "מה תפקיד הכבד?",
    options: [
      "להפיק כדוריות דם אדומות במח עצם",
      "לסנן רעלים מהדם, לייצר מיצי מרה ולאחסן חומרי מזון",
      "לייצא חמצן מהדם כדי לייצב טמפרטורת ליבה",
      "לקלוט אור מהעין ולהפיק אות חשמלי לראייה",
    ],
    correctIndex: 1,
  ...
  },
  {
    ...
    stem: "מה תפקיד הלבלב?",
    options: [
      "להחליף גזים בריאות עם האוויר",
      "לייצר אינסולין ולסייע בעיכול",
      "להניע דם באותו קצב כמו עורק ראשי",
      "לעבד אור בלוחית הרשתית",
    ],
    correctIndex: 1,
  ...
  },
  {
    ...
    stem: "מה תפקיד בלוטת התריס?",
    options: [
      "לייצר אנזימי עיכול עיקריים בלבד",
      "לייצר הורמונים שמווסתים חילוף חומרים",
      "להכניס חמצן רק דרך האף",
      "לקודד צבע וצורה בזווית ראייה",
    ],
    correctIndex: 1,
  ...
  },
  {
    ...
    stem: "מה תפקיד העור?",
    options: [
      "לעכל מזון בעיקר דרך שכבת העור",
      "להגן על הגוף, לווסת חום ולחוש מגע",
      "להעביר חמצן לדם כמו הריאות",
      "לחוש חום וקור בלי לשמש כמחסום",
    ],
    correctIndex: 1,
  ...
  },
  {
    ...
    stem: "מה תפקיד מערכת הלימפה?",
    options: [
      "לפרק סוכרים בקיבה בעיקר",
      "לסייע במערכת החיסון ולנקז נוזלים",
      "לספק חמצן ישירות מהאף לתאים",
      "לזהות צלילים בתדר נמוך",
    ],
    correctIndex: 1,
  ...
  },
  {
    ...
    stem: "מה תפקיד העצמות?",
    options: [
      "נקודות עיגון בלי מסגרת שלמה לגוף",
      "מסגרת לגוף, הגנה על איברים ותנועה עם השרירים",
      "קשיחות סתמית בלי תמיכה או תנועה",
      "הגנה על איברים בלי תמיכה או אפשרות לזוז",
    ],
    correctIndex: 1,
  ...
  },
  {
    ...
    stem: "מה תפקיד השרירים?",
    options: [
      "תנועה בלי חיבור לעצמות ולמפרקים",
      "להזיז חלקי גוף ולייצר תנועה ביחד עם השלד",
      "הגנה על איברים כמו תפקיד העור",
      "פירוק מזון במערכת העיכול",
    ],
    correctIndex: 1,
    explanation: "השרירים מחוברים לעצמות. כאשר השריר מתכווץ, הוא מושך את העצם וגורם לתנועה.",
    theoryLines: [
  ...
  },
  {
    ...
    stem: "מה תפקיד הפרחים?",
    options: [
      "יופי נראה בלי קשר לזרעים או להאבקה",
      "רבייה וייצור זרעים דרך מבנה הפרח",
      "חישוף אור בלי תפקיד ברבייה",
      "נשימה דרך הפרח בלי קשר לזרעים",
    ],
    correctIndex: 1,
  ...
  },
  {
    ...
    stem: "מה זה עונות השנה?",
    options: [
      "תקופת חום בלבד כל השנה",
      "קיץ, חורף, סתיו ואביב — מזג שונה לאורך השנה",
      "חורף קר בלי מעבר לאביב",
      "אביב לח בלי תקופה חמה או קרה",
    ],
    correctIndex: 1,
    explanation: "יש ארבע עונות: קיץ (חם), חורף (קר), סתיו ואביב (מעבר). כל עונה יש מזג אוויר שונה.",
    theoryLines: [
  ...
  },
  {
    ...
    stem: "מה זה תצפית?",
    options: [
      "הבטחה מהירה בלי רישום פרטים",
      "לצפות בזהירות ולרשום מה רואים",
      "האזנה בלי תיאור חזותי של האירוע",
      "מגע אקראי בלי תיעוד מה רואים",
    ],
    correctIndex: 1,
  ...
  },
  {
    ...
    stem: "למה חשוב לעשות ניסויים?",
    options: [
      "משום שהמדע מתבסס רק על הצבעות דעת בלי עדות חוזרת",
      "ללמוד, לבדוק ולהבין שיטתית איך דברים עובדים",
      "רק כדי להציג מופע בכיתה בלי משתנה מוסכם",
      "כדי לשמור הכל בזיכרון בלי מסקנה משווה",
    ],
    correctIndex: 1,
    explanation: "ניסויים עוזרים לנו ללמוד, לבדוק ולהבין איך דברים עובדים. זה דרך מצוינת ללמוד מדע.",
    theoryLines: [
  ...
  },
  {
    ...
    stem: "מה צריך לעשות אחרי ניסוי?",
    options: [
      "להשאיר ציוד עם שיירי חומר בלי לשטוף לפי נוהל הכיתה",
      "לנקות, לכתוב מה למדנו ולחשוב מה זה אומר",
      "לדלג על סיכום כי הניסוי כבר הוצג לכולם",
      "לפרק מיד את הרישום ללא בדיקה שהמספרים הועתקו",
    ],
    correctIndex: 1,
  ...
  },
  {
    ...
    stem: "מה זה מדידה?",
    options: [
      "הערכה בעין בלי כלי מדידה",
      "למדוד בדיוק את מה שרוצים לבדוק",
      "האזנה למשך הצליל בלי יחידות",
      "מגע גס בלי ספרות או סקאלה",
    ],
    correctIndex: 1,
