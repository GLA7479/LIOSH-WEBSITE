...
export default function Curriculum() {
  ...
  const subjectDescriptions = {
    math: "עיון בנושאי החשבון ובחירת הרמה לפי כיתה — כפי שמוצגים בדף המשחק ובחירת הנושא.",
    english:
            ...
            <div className="bg-white/5 rounded-2xl border border-white/10 p-6" dir="rtl">
              <div className="prose prose-invert max-w-none">
                <div className="bg-emerald-500/20 border-r-4 border-emerald-500 p-4 rounded-lg mb-6">
                  ...
                  <ul className="list-disc pr-6 space-y-2">
                    ...
                    <li><strong>נושאים לפי כיתה</strong> — הרשימות למטה תואמות את בחירת הנושא בדף החשבון</li>
                  </ul>
                </div>
                ...
                <div className="bg-blue-500/20 border-r-4 border-blue-500 p-4 rounded-lg mb-6">
                  ...
                  <ol className="list-decimal pr-6 space-y-1 mb-4">
                    ...
                    <li>כפל - עד 20</li>
                    <li>השוואה</li>
                    <li>תחושת מספר - שכנים, זוגי/אי-זוגי, השלמה ל-10, עשרות/יחידות, ישר המספרים, מנייה וספירה (כולל השלמת מספר פשוטה ואיזון בסיסי בלבד — לא אלגברה פורמלית)</li>
                ...
                <div className="bg-blue-500/20 border-r-4 border-blue-500 p-4 rounded-lg mb-6">
                  ...
                  <ol className="list-decimal pr-6 space-y-1 mb-4">
                    ...
                    <li>השוואה</li>
                    <li>תחושת מספר (כולל השלמת מספר פשוטה — לא משוואות אלגבריות כנושא נפרד)</li>
                  ...
                  <div className="bg-yellow-500/20 p-3 rounded text-sm">
                    <strong>הערות:</strong> אין מספרים שליליים. עשרוניים בסיסיים מכיתה זו. סימני התחלקות פורמליים מכיתה זו. ללא משוואות אלגבריות כנושא נפרד — רק השלמת מספר ואיזון פשוט במסגרת תחושת מספר וסדר פעולות. חילוק עם שארית.
                  </div>
                </div>
              ...
              <div className="bg-emerald-500/20 border-r-4 border-emerald-500 p-4 rounded-lg">
                ...
                <p className="text-center">
                  המערכת מציעה <strong>6 כיתות</strong>, <strong>3 רמות קושי</strong> לכל כיתה וברירת נושאים כפי שמופיעים למעלה ובדף החשבון — ללא טענה לאישור רשמי מלא של תוכנית משרד החינוך.
                </p>
              </div>
            </div>
            </div>
