            ...
            <div className="prose prose-invert max-w-none">
              <div className="bg-emerald-500/20 border-r-4 border-emerald-500 p-4 rounded-lg mb-6">
                ...
                <ul className="list-disc pr-6 space-y-2">
                  ...
                  <li><strong>24 נושאים מתמטיים</strong> בסך הכל</li>
                </ul>
              </div>
              ...
              <div className="bg-blue-500/20 border-r-4 border-blue-500 p-4 rounded-lg mb-6">
                ...
                <ol className="list-decimal pr-6 space-y-1 mb-4">
                  <li>חיבור - כולל תרגילי השלמה לעשר</li>
                  <li>חיסור</li>
                  <li>כפל - עד 20</li>
                  <li>חילוק - עד 20</li>
                  <li>השוואה</li>
                ...
                <div className="bg-white/5 p-3 rounded mb-3">
                  ...
                  <div className="text-sm space-y-2">
                    <div><strong>קל:</strong> חיבור עד 10 (כולל השלמה לעשר), חיסור עד 10, כפל עד 5×5, חילוק עד 20, השוואה עד 10, תחושת מספר עד 10 (ישר המספרים, מנייה וספירה)</div>
                    <div><strong>בינוני:</strong> חיבור עד 20 (כולל השלמה לעשר), חיסור עד 20, כפל עד 5×5, חילוק עד 20, השוואה עד 20, תחושת מספר עד 20 (ישר המספרים, מנייה וספירה)</div>
                    <div><strong>קשה:</strong> חיבור עד 20 (כולל השלמה לעשר), חיסור עד 20, כפל עד 5×5, חילוק עד 20, השוואה עד 20, תחושת מספר עד 20 (ישר המספרים, מנייה וספירה)</div>
                  </div>
                </div>
                <div className="bg-yellow-500/20 p-3 rounded text-sm">
                  <strong>הערות:</strong> כפל וחילוק עד 20. אין שברים. אין מספרים שליליים. רק תרגילים ישירים (ללא נעלם).
                </div>
              </div>
              ...
              <div className="bg-blue-500/20 border-r-4 border-blue-500 p-4 rounded-lg mb-6">
                ...
                <div className="bg-white/5 p-3 rounded mb-3">
                  <h4 className="font-semibold mb-2">רמות קושי:</h4>
                  <div className="text-sm space-y-2">
                    <div><strong>קל:</strong> חיבור/חיסור עד 50, כפל עד 5×5, חילוק עד 50, שברים חצי/רבע, סימני התחלקות ב-2,5,10, השוואה עד 1000</div>
                    <div><strong>בינוני:</strong> חיבור/חיסור עד 100, כפל עד 10×10, חילוק עד 100, שברים חצי/רבע, סימני התחלקות ב-2,5,10, השוואה עד 1000</div>
                    <div><strong>קשה:</strong> חיבור/חיסור עד 100, כפל עד 10×10, חילוק עד 100, שברים חצי/רבע, סימני התחלקות ב-2,5,10, השוואה עד 1000</div>
                  </div>
                </div>
                <div className="bg-yellow-500/20 p-3 rounded text-sm">
              ...
              <div className="bg-blue-500/20 border-r-4 border-blue-500 p-4 rounded-lg mb-6">
                ...
                <ol className="list-decimal pr-6 space-y-1 mb-4">
                  ...
                  <li>שברים - כולל צמצום, הרחבה, חיבור וחיסור</li>
                  <li>אחוזים</li>
                  <li>סדרות</li>
                  <li>עשרוניים</li>
                  <li>עיגול</li>
              ...
              <div className="bg-emerald-500/20 border-r-4 border-emerald-500 p-4 rounded-lg">
                ...
                <p className="text-center">
                  המערכת כוללת <strong>24 נושאים מתמטיים</strong>, <strong>6 כיתות</strong>, <strong>3 רמות קושי</strong> לכל כיתה, 
