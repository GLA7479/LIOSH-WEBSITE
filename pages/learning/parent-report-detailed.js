...
function normalizeExecutiveSummary(payload) {
...
function ExecutiveSummarySection({ es, compact }) {
  return (
...
function SubjectPhase3Insights({ sp, compact }) {
...
function TopicRecommendationExplainStrip({ tr }) {
