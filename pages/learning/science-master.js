...
const QUESTIONS = [
  // ========= גוף האדם =========
  {
    ...
    maxLevel: "medium",
    type: "mcq",
    stem: "איזה איבר בגוף אחראי על שאיפת האוויר והוצאתו?",
    options: ["הלב", "הריאות", "הקיבה", "המוח"],
    correctIndex: 1,
    explanation:
      "הריאות הן איבר הנשימה העיקרי בגוף. הן מכניסות חמצן ומוציאות פחמן דו־חמצני.",
    theoryLines: [
      "מערכת הנשימה אחראית על חילוף גזים בין הגוף לסביבה.",
      "הריאות מכניסות חמצן ומוציאות פחמן דו־חמצני.",
    ],
  },
  {
    id: "body_2",
    ...
    maxLevel: "hard",
    type: "mcq",
    stem: "מה תפקידה העיקרי של מערכת הדם?",
    options: [
      "להכין מזון בקיבה",
      "להוביל חמצן וחומרים לכל תאי הגוף",
      "להגן על הגוף מפני פציעות",
      "לשלוט במחשבות",
    ],
    correctIndex: 1,
    explanation:
      "מערכת הדם מובילה חמצן, מזון וחומרים חיוניים לכל תאי הגוף ומחזירה פסולת לריאות ולכליות.",
    theoryLines: [
      "הלב משמש כמשאבה הדוחפת את הדם בכל הגוף.",
      "דם מוביל חמצן מהמוח, הריאות ושאר האיברים.",
    ],
  },
  {
    id: "body_3",
    ...
    maxLevel: "hard",
    type: "true_false",
    stem: "השלד נותן לגוף צורה וגם מגן על איברים פנימיים חשובים.",
    options: ["נכון", "לא נכון"],
    correctIndex: 0,
    explanation:
      "השלד תומך בגוף, מאפשר תנועה באמצעות השרירים, ומגן על איברים חשובים כמו המוח (בגולגולת) והלב והריאות (בית החזה).",
    theoryLines: [
      "השלד מורכב מעצמות רבות המחוברות זו לזו.",
      "השלד לא רק תומך בגוף אלא גם מגן על איברים פנימיים.",
    ],
  },
  // ========= בעלי חיים =========
  {
    ...
    correctIndex: 2,
    explanation:
      "יונקים ממליטים צאצאים חיים ומניקים אותם בחלב. חתול הוא יונק, בעוד שצפרדע ותרנגול הם דו-חיים ועופות.",
    theoryLines: [
      "יונקים: פרווה/שיער, המלטת צאצאים חיים, הנקה בחלב.",
      "עופות מטילים ביצים ובדרך כלל מכוסים נוצות.",
    ],
  },
  {
    id: "animals_2",
    ...
    maxLevel: "hard",
    type: "match",
    stem: "התאם בין בעל החיים לסביבת החיים הטבעית שלו.",
    pairsQuestion: ["דולפין", "גמל", "ינשוף", "חתול בית"],
    pairsAnswer: ["ים", "מדבר", "יער/לילה", "בית האדם"],
    explanation:
      "כל בעל חיים מותאם לסביבת חיים מסוימת: לדוגמה, גמל מותאם למדבר ודולפין לים.",
    theoryLines: [
      "בעלי חיים מותאמים לסביבת החיים שלהם (טמפרטורה, מזון, מחסה).",
      "חלק מההתאמות הן בצורת הגוף, בצבע, ובהתנהגות.",
    ],
  },
  // ========= צמחים =========
  {
    ...
    theoryLines: [
      ...
      "השורשים סופגים מים ומינרלים מהקרקע.",
    ],
  },
  {
    id: "plants_2",
    ...
    stem: "מהי פוטוסינתזה?",
    options: [
      "תהליך שבו הצמח נושר מעליו",
      "תהליך שבו הצמח מייצר מזון מאור השמש",
      "תהליך שבו הצמח שותה מים",
      "תהליך שבו הצמח נרקב",
    ],
    correctIndex: 1,
    explanation:
      "פוטוסינתזה היא תהליך שבו הצמח משתמש באור השמש, במים ובפחמן דו־חמצני כדי לייצר גלוקוז (מזון) ולשחרר חמצן.",
    theoryLines: [
      "פוטוסינתזה מתרחשת בעיקר בעלים, בתוך הכלורופלסטים.",
      "בתהליך נוצר מזון לצמח וחמצן המשוחרר לאוויר.",
    ],
  },
  // ========= חומרים =========
  {
    ...
    theoryLines: [
      ...
      "חימום וקירור יכולים לגרום לשינוי מצב צבירה.",
    ],
  },
  {
    id: "materials_2",
    ...
    maxLevel: "hard",
    type: "true_false",
    stem: "תמיסה של מלח ומים היא דוגמה לתערובת הומוגנית.",
    options: ["נכון", "לא נכון"],
    correctIndex: 0,
    explanation:
    ...
    theoryLines: [
      ...
      "תמיסה של מלח במים היא דוגמה נפוצה לתערובת הומוגנית.",
    ],
  },
  // ========= כדור הארץ והחלל =========
  {
    ...
    correctIndex: 1,
    explanation:
      "יום ולילה נוצרים בגלל שכדור הארץ מסתובב סביב צירו. החלק שפונה לשמש חווה יום, והחלק שמוסתר בשחור חווה לילה.",
    theoryLines: [
      "לכדור הארץ סיבוב עצמי (סביב צירו) הנמשך כ-24 שעות.",
      "החלק הפונה לשמש הוא יום, והחלק הרחוק מהשמש הוא לילה.",
    ],
  },
  {
    id: "earth_2",
    ...
    theoryLines: [
      "לכדור הארץ שני סוגי תנועה: סיבוב סביב צירו, והקפה סביב השמש.",
      "ההקפה סביב השמש אחראית על העונות.",
    ],
  },
  // ========= סביבה ואקולוגיה =========
  {
    ...
    theoryLines: [
      ...
      "מיחזור הוא שימוש חוזר בחומרים לייצור מוצרים חדשים.",
    ],
  },
  {
    id: "env_2",
    ...
    maxLevel: "hard",
    type: "true_false",
    stem: "גזי חממה הם גזים הלוכדים חום באטמוספרה ועלולים לגרום להתחממות גלובלית.",
    options: ["נכון", "לא נכון"],
    correctIndex: 0,
    explanation:
      "גזי חממה כמו פחמן דו־חמצני ומתאן לוכדים חום, וצבירה שלהם באטמוספרה מגבירה את אפקט החממה.",
    theoryLines: [
      "אפקט החממה הטבעי חיוני לחיים, אך הגברה שלו גורמת להתחממות יתר.",
      "שריפת דלקים, תעשייה ותחבורה מוסיפים גזי חממה לאטמוספרה.",
    ],
  },
  // ========= ניסויים ותהליכים =========
  {
    ...
    maxLevel: "medium",
    type: "scenario",
    stem: "שמת קרח בשתי צלחות: אחת בחדר ואחת בשמש. באיזו צלחת הקרח יימס מהר יותר ולמה?",
    options: [
      "בחדר, כי שם קר יותר",
      "בשמש, כי היא נותנת יותר חום",
      "אין הבדל, הקרח נמס באותו קצב",
      "בצלחת קטנה יותר תמיד נמס מהר יותר",
    ],
    correctIndex: 1,
    explanation:
      "בשמש הקרח מקבל יותר אנרגיית חום ולכן נמס מהר יותר מאשר בחדר.",
    theoryLines: [
      "חום הוא סוג של אנרגיה שגורם לחומרים להתחמם ולהחליף מצב צבירה.",
      "ככל שחומר מקבל יותר חום, כך החלקיקים שלו נעים מהר יותר.",
    ],
  },
  {
    id: "exp_2",
    ...
    maxLevel: "hard",
    type: "order",
    stem: "סדר את שלבי מחזור המים מהתחלה לסוף:",
    orderedSteps: ["אידוי", "עיבוי", "ירידת משקעים", "איסוף במקורות מים"],
    explanation:
      "ראשית המים מתאדים, אחר כך מתעבים לעננים, לאחר מכן יורדים כגשם/שלג ולבסוף נאספים בים, אגמים ומי תהום.",
    theoryLines: [
      "מחזור המים הוא תהליך מתמשך שבו מים נעים בין הים, היבשה והאטמוספרה.",
      "השלבים העיקריים: אידוי, עיבוי, משקעים ואיסוף.",
    ],
  },
];
        ...
        >
          ...
          {!gameActive ? (
            <>
              ...
              >
                ...
                <ul className="list-disc pr-4 space-y-0.5">
                  ...
                  <li>לחץ על 💡 Hint להסבר קצר, ועל "הסבר מלא" לפירוט.</li>
            ...
            <>
              ...
              <div
                ref={gameRef}
                className="w-full max-w-md flex flex-col items-center justify-start mb-2 flex-1"
                style={{
                  height: "var(--game-h, 360px)",
                  minHeight: "270px",
                }}
              >
                    ...
                    {currentQuestion.options?.map((opt, idx) => {
                      ...
                      return (
                        <button
                          ...
                          className={`rounded-xl border-2 px-4 py-3 text-sm sm:text-base font-bold text-center transition-all active:scale-95 disabled:opacity-60 ${
